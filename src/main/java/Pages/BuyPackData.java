...
public class BuyPackData {
    ...
    By muaGoiCuocLocator = By.xpath("//*[@id=\"root\"]/div[1]/div[1]/div/div/div[2]/ul/li[3]");
    ...
    By addVoucherLocator = By.xpath("//*[@id=\"root\"]/div[1]/div[2]/div/div/div[2]/div[2]/div[2]/div/div/div[3]/div[1]");
...
//public void ramdomLoaiGoiCuoc(){
//        // ramdom 1 trong 3 loai theo thang, quy, nam
//       // ramdom ngan hang( vietcombank, techcombank,
//    // ma khuyen mai
//    // luu data moi goi co khuyen mai va khong co khuyen mai
//    //
//    WebElement soKyTuDaCo = wait50.until(ExpectedConditions.visibilityOfElementLocated(soKytuHienjCoLocator));
//    String numberText = soKyTuDaCo.getText();
//    String[] parts = numberText.split("\\s+"); // Tách chuỗi bằng khoảng trắng
//    String numberPart = parts[0]; // Phần số sẽ là phần tử đầu tiên trong mảng
//    numberPart = numberPart.replaceAll("\\D", ""); // Loại bỏ tất cả các ký tự không phải số
//    int soKytuDaCo = Integer.parseInt(numberPart);
//    System.out.println(soKytuDaCo);
//    int thoiluong = 0;
//    System.out.println("den 1");
////    WebElement thang = wait50.until(ExpectedConditions.visibilityOfElementLocated(thangLocator));
////    WebElement quy = wait50.until(ExpectedConditions.visibilityOfElementLocated(quyLocator));
////    WebElement nam = wait50.until(ExpectedConditions.visibilityOfElementLocated(namLocator));
...
//    int randomIndex = random.nextInt((element.length));
//    System.out.println(random);
//    WebElement randomElement = element[randomIndex];
//    System.out.println(randomElement);
//    randomElement.click();
//    if(randomElement == thang){
//        thoiluong = 1250000;
//    } else if (randomElement == quy) {
//        thoiluong = 3750000;
//    }else {
//        thoiluong = 15000000;
//    }
//    System.out.println(thoiluong);
//    System.out.println("den 3");
//    }
...
int soKyTuBanDau = 0;
    ...
    public void chonVoucherPhanTramVaThanhToan(String voucher) throws InterruptedException {
...
// Loại bỏ ký tự 'đ' nếu cần thiết
    ...
    Thread.sleep(1000);
        ...
        String voucher40 = "GIAM%TIEN";
        String voucher55 = "HUONGGIAM55%";
        String voucher20 = "HUONGGIAM20";
        String voucher60 = "GIAM";
        int soTienThanhToanBaSoDau = 0;
        if(voucher.equalsIgnoreCase(voucher40)){
            phantramgiam = 40;
            soTienThanhToanBaSoDau = (int) ((tienGoiCuoc - Math.ceil(tienGoiCuoc * phantramgiam /100))/1000);

        }        if(voucher.equalsIgnoreCase(voucher55)){
            phantramgiam = 55;
            soTienThanhToanBaSoDau = (int) ((tienGoiCuoc - Math.ceil(tienGoiCuoc * phantramgiam /100))/1000);
...
// Chuyển đổi chuỗi thành số
   ...
   public void chonVoucherTangKyTuVaThanhToan(String voucher) throws InterruptedException {
       By tienGoiCuocLocator = By.xpath("//*[@id=\"root\"]/div[1]/div[2]/div/div/div[2]/div[2]/div[2]/div/div/div[2]/div[2]/p[2]");
       WebElement tienGoiCuocBtn = wait50.until(ExpectedConditions.visibilityOfElementLocated(tienGoiCuocLocator));
       String tienGoiCuocString = tienGoiCuocBtn.getText();
       System.out.println(tienGoiCuocString);
...
//        js.executeScript("window.scrollBy(0, 200)");
    ...
    public static void quayVeTrangChu() throws InterruptedException {
        ...
        Thread.sleep(2000);
//        By boquaLocator = By.xpath("/html/body/div[7]/div[3]/div/div[1]/button");
...
//        boquabtn.click();
    ...
    public void kiemTraHanSuDung(int thang){
        ...
        // Chuyển đổi ThoiGianDuyetGoi thành LocalDateTime
...
// Định dạng chuỗi thời gian hết hạn
        ...
        if(formattedThoiGianHetHan.equalsIgnoreCase(ThoiGianHetHanWeb.getText()) || formattedThoiGianHetHan1.equalsIgnoreCase(ThoiGianHetHanWeb.getText())){
    ...
    public void checkChuyenTrangLichSuThanhToan() throws InterruptedException {
